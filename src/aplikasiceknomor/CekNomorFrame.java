...
public class CekNomorFrame extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtNomor, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(159, 159, 159)
                        .addComponent(btnCek)))
    ...
    private void btnCekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCekActionPerformed
        cekNomor();    // memanggil method cekNomor yang berisikan kode untuk pengecekan nomor
    }//GEN-LAST:event_btnCekActionPerformed
    
    private void cekNomor() {
    try {
        int angka = Integer.parseInt(txtNomor.getText());
        ...
        String tipeBilangan = isPrima ? "Bilangan Prima" : "Bukan Bilangan Prima";

        // Tampilkan hasil
       JOptionPane.showMessageDialog(this, "Angka " + angka + " adalah " + jenisBilangan + " dan " + tipeBilangan, "Hasil", JOptionPane.INFORMATION_MESSAGE);
    } catch (NumberFormatException ex) {
        JOptionPane.showMessageDialog(this, "Input tidak valid! Masukkan angka saja.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
    // Metode tambahan untuk mengecek bilangan prima
    private boolean isBilanganPrima(int number) {
    ...
    private void txtNomorFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNomorFocusGained
        txtNomor.setText("");  // untuk membersihkan teks saat mendapatkan fokus       
